...
class Reviews extends React.Component {
  ...
  render(){
    ...
    <div>
      ...
      <NewReviewModal  close={this.closeModal} isOpen= {this.state.modalIsOpen} productName= {this.props.product.name} productId= {this.props.productId} characteristics= {this.props.meta.characteristics}/>
    </div>)
  }
