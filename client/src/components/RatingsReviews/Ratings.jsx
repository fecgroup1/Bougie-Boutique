...
const Ratings = ({ meta, filterReviews, filteredFor }) => {
  ...
  return (<div>
    ...
    <p>{calculatePercent(meta.recommended)}% of reviews recomend this product</p>
        ...
        {filteredFor['1']? <i>&#10003;</i> : <div></div>}<a onClick= {()=> filterReviews('1')}>1 stars </a><meter min= '0' max= '100' value= {meta.ratings['1']? (meta.ratings['1'] / totalReviews)* 100 : 0}></meter><br></br><br></br>
